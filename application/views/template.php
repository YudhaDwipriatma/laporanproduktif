  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/produk')?>" class="logo"><b>TOKO ASUS</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.html"><img src="<?=base_url()?>assets/img/asus.png" class="img-circle" width="60"></a></p>
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            image: '<?=base_url()?>assets/img/asus.png',
